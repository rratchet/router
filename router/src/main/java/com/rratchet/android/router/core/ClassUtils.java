 ...
 * 日 期：      18-7-30
 * 版 本：      V1.0
 * 描 述：      Scanner, find out class with any conditions, copy from google source code.
 *
 * </pre>
 *
 * @author ASLai
...
final class ClassUtils {
    ...
    /**
     * The constant EXTRACTED_NAME_EXT.
     */
    private static final String EXTRACTED_NAME_EXT = ".classes";
    /**
     * The constant EXTRACTED_SUFFIX.
     */
    private static final String EXTRACTED_SUFFIX   = ".zip";

    /**
     * The constant SECONDARY_FOLDER_NAME.
     */
    ...
    /**
     * The constant KEY_DEX_NUMBER.
     */
    private static final String KEY_DEX_NUMBER = "dex.number";

    /**
     * The constant VM_WITH_MULTIDEX_VERSION_MAJOR.
     */
    private static final int VM_WITH_MULTIDEX_VERSION_MAJOR = 2;
    /**
     * The constant VM_WITH_MULTIDEX_VERSION_MINOR.
     */
    private static final int VM_WITH_MULTIDEX_VERSION_MINOR = 1;

    /**
     * Gets multi dex preferences.
     *
     * @param context the context
     *
     * @return the multi dex preferences
     */
     ...
     *
     * @return 所有class的集合 file name by package name
     *
    ...
    public static Set<String> getFileNameByPackageName(Context context, final String packageName) throws NameNotFoundException, IOException, InterruptedException {
            ...
            executor.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Log.e(Constants.SDK_NAME, "Scan map file in dex files made error.", ignore);
                    } finally {
                        if (null != dexfile) {
                            try {
                                dexfile.close();
        ...
        Log.d(Constants.SDK_NAME, "Filter " + classNames.size() + " classes by packageName <" + packageName + ">");
        return classNames;
    }
...
//        通过是否存在sp中的multidex.version是不准确的，因为从低版本升级上来的用户，是包含这个sp配置的
        ...
        if (Router.debuggable() || Router.isAppInDebug(context)) {
    ...
    private static List<String> tryLoadInstantRunDexFile(ApplicationInfo applicationInfo) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && null != applicationInfo.splitSourceDirs) {
            ...
            Log.d(Constants.SDK_NAME, "Found InstantRun support");
        } else {
            try {
                ...
                Log.e(Constants.SDK_NAME, "InstantRun support error, " + e.getMessage());
            }
        }
    ...
    private static boolean isVMMultidexCapable() {
        ...
        Log.i(Constants.SDK_NAME, "VM with name " + vmName + (isMultidexCapable ? " has multidex support" : " does not have multidex support"));
